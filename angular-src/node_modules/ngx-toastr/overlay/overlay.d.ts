...
export declare class Overlay {
    ...
    constructor(_overlayContainer: OverlayContainer, _componentFactoryResolver: ComponentFactoryResolver, _appRef: ApplicationRef, _injector: Injector, _ngZone: NgZone);
    /**
     * Creates an overlay.
