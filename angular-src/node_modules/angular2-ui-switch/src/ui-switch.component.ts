...
@Component({
  ...
  [class.switch-medium-v2]="size === 'medium-v2'"
  ...
  styles: [`
    ...
    .switch-medium-v2.checked small {
    left: 22px;
    }
...
export class UiSwitchComponent implements ControlValueAccessor {
  ...
  defaultBgColor: string = '#777777';
  defaultBoColor: string = 'rgba(#dfdfdf, 0)';
